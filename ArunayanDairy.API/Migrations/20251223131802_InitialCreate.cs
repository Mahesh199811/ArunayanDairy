        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    MinOrderQuantity = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false, defaultValue: 1m),
                    MaxOrderQuantity = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAvailabilities_AvailableDate",
                table: "ProductAvailabilities",
                column: "AvailableDate");

            migrationBuilder.CreateIndex(
                name: "IX_ProductAvailabilities_ProductId_AvailableDate",
                table: "ProductAvailabilities",
                columns: new[] { "ProductId", "AvailableDate" },
                unique: true);
